...
void View::initialize()
{
  ...
  osgViewer::View::setSceneData(_ppGroup);
...
void View::resetPostProcessingEffects()
{
  initializePPU();
...
void View::setupPostProcessingEffects()
{
  _lastUnit = lastUnit(true);
...
void View::updateCameraRenderTextures(bool recreate)
{
...
void View::updateWindowRect(const osgViewer::ViewerBase::Windows& windows)
{
...
View::RenderTexture View::renderTexture(osg::Camera::BufferComponent bufferComponent, bool recreate)
{
...
ref_ptr<Texture2D> View::createRenderTexture(osg::Camera::BufferComponent bufferComponent)
{
...
ref_ptr<Unit> View::bypassUnit(osg::Camera::BufferComponent bufferComponent)
{
...
ref_ptr<osgPPU::Unit> View::lastUnit(bool reset)
{
...
ref_ptr<osgPPU::Unit> View::unitForType(PostProcessingEffect::UnitType type)
{
...
string View::postProcessingEffectName(unsigned int index)
{
  unsigned int c = 0;
